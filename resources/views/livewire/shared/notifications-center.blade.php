<div dir="rtl" class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        <div class="flex items-center justify-between flex-wrap gap-4">
            <div>
                <h2 class="text-xl font-bold text-gray-900">🔔 مركز الإشعارات</h2>
                <p class="text-sm text-gray-600 mt-1">
                    لديك <span class="font-semibold text-indigo-600">{{ $unreadCount }}</span> إشعار غير مقروء
                </p>
            </div>
    ...
    {{-- Filters --}}
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
        <h3 class="text-sm font-semibold text-gray-900 mb-4">تصفية الإشعارات</h3>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div class="flex items-end">
                <label class="flex items-center gap-2 cursor-pointer">
                    ...
                    <span class="text-sm font-medium text-gray-700">إظهار غير المقروء فقط</span>
                </label>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                                ...
                                <div class="flex items-start justify-between gap-3">
                                    <div class="flex-1">
                                        ...
                                        <div class="flex items-center gap-3 mt-2">
                                            ...
                                            @if($isUnread)
                                                <span class="px-2 py-0.5 text-xs font-semibold bg-indigo-600 text-white rounded-full">جديد</span>
                                            @endif
                                        </div>
                                    </div>
        ...
        @else
            <div class="p-12 text-center">
                ...
                <h3 class="text-lg font-semibold text-gray-900 mb-1">لا توجد إشعارات</h3>
