    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ __('حاسبة تكاليف الاستيراد') }}</h1>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('احسب تكاليف استيراد شحنتك بدقة') }}</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white mb-6">{{ __('معلومات الشحنة') }}</h2>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Purchase Price --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                {{ __('سعر الشراء (USD)') }} <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                {{ __('بلد المنشأ') }} <span class="text-red-500">*</span>
                            </label>
                            <input type="text" wire:model.blur="origin_country"
                                   placeholder="{{ __('مثال: China') }}"
                                   class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="origin_port"
                                   placeholder="{{ __('مثال: Shanghai Port') }}"
                                   class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="product_category"
                                   placeholder="{{ __('مثال: Electronics') }}"
                                   class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tfoot class="bg-gray-50 dark:bg-gray-900">
                                <tr>
                                    <td class="px-6 py-4 text-right font-semibold text-gray-900 dark:text-white">{{ __('المجموع الفرعي:') }}</td>
                                ...
                                <tr>
                                    <td class="px-6 py-4 text-right font-semibold text-gray-900 dark:text-white">{{ __('الإجمالي الكلي:') }}</td>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('نسبة الرسوم الجمركية') }}</p>
                            <p class="text-2xl font-bold text-blue-600 dark:text-blue-400">{{ $duty_ratio }}%</p>
                        </div>

                        {{-- Logistics Share --}}
                        <div class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                            <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('نسبة تكاليف اللوجستيات') }}</p>
                            <p class="text-2xl font-bold text-purple-600 dark:text-purple-400">{{ $logistics_share }}%</p>
                        </div>

                        {{-- Lead Time --}}
                        <div class="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            <p class="text-xs text-gray-600 dark:text-gray-400 mb-1">{{ __('زمن التسليم المتوقع') }}</p>
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $lead_time_days }} {{ __('يوم') }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="font-semibold text-blue-900 dark:text-blue-300 mb-2">{{ __('ملاحظة') }}</h4>
                            <p class="text-sm text-blue-800 dark:text-blue-400">
                                {{ __('الحسابات تقديرية وقد تختلف حسب الظروف الفعلية. يُنصح بالتحقق من الأسعار مع شركات الشحن والجمارك.') }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" wire:model="calculationName"
                               placeholder="{{ __('مثال: استيراد من الصين - يناير 2025') }}"
                               class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500">
