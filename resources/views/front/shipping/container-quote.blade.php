...
@section('title', 'عرض سعر حاوية - جماركي')
    ...
    <div class="bg-gradient-to-l from-[#0F2E5D] to-[#1a4d8f] text-white py-12 px-4">
        <div class="container mx-auto max-w-7xl">
            ...
            <p class="text-xl text-blue-100 max-w-3xl">
                احصل على عروض فورية من أفضل شركات الشحن العالمية. قارن الأسعار والمواعيد واختر الأنسب لاحتياجاتك.
            </p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-teal-500">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-800">عروض فورية</h3>
                </div>
                <p class="text-gray-600 text-sm">
                    احصل على عروض الأسعار في ثوانٍ من أكثر من 10 شركات شحن عالمية
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-blue-500">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-800">أسعار شفافة</h3>
                </div>
                <p class="text-gray-600 text-sm">
                    جميع الأسعار شاملة الرسوم الأساسية. قد تضاف رسوم محلية حسب الميناء
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-t-4 border-purple-500">
                <div class="flex items-center mb-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-800">دعم مستمر</h3>
                </div>
                <p class="text-gray-600 text-sm">
                    فريقنا متواجد على مدار الساعة لمساعدتك في اختيار العرض المناسب
                </p>
            </div>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-orange-700 text-sm leading-relaxed">
                        السعر شامل الرسوم الظاهرة وقد تُضاف رسوم محلية حسب ميناء الوصول والجمارك المحلية. 
                        يُرجى مراجعة التفاصيل الكاملة قبل تأكيد الحجز.
                    </p>
                </div>
            </div>
        </div>
