...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <div class="mb-6 flex justify-between items-center">
    <h1 class="text-3xl font-bold text-gray-900">عرض #{{ $quote->id }}</h1>
    <a href="{{ route('export.quotes.index') }}" class="text-blue-600 hover:underline">← العودة</a>
  </div>
  ...
  <div class="bg-white shadow-md rounded-lg p-6 mb-6">
    <div class="grid grid-cols-2 gap-4 mb-6">
      <div>
        <p class="text-sm font-medium text-gray-500">الشحنة</p>
