...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-2">إدارة أدوار المستخدمين وصلاحيات الوصول</p>
        </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="p-12 text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                هذه صفحة مؤقتة - سيتم ربط إدارة الأدوار والصلاحيات لاحقاً
            </p>
            ...
            <div class="inline-flex items-start gap-3 px-6 py-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg text-right max-w-2xl">
                ...
                <div class="text-sm text-blue-800 dark:text-blue-200">
                    ...
                    <ul class="space-y-1 text-right mr-4">
                        <li>• إنشاء وتعديل الأدوار (Admin, Manager, User, etc.)</li>
                        <li>• تحديد الصلاحيات لكل دور (View, Create, Edit, Delete)</li>
                        <li>• ربط المستخدمين بالأدوار المناسبة</li>
                        <li>• مراقبة وتدقيق تغييرات الصلاحيات</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">صلاحيات مرنة</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm">تحديد صلاحيات دقيقة لكل دور حسب احتياجات العمل</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">أمان متقدم</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm">حماية البيانات الحساسة بنظام صلاحيات محكم</p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2">سجل التدقيق</h3>
            <p class="text-gray-600 dark:text-gray-400 text-sm">تتبع جميع التغييرات على الأدوار والصلاحيات</p>
        </div>
