...
<aside class="fixed top-0 right-0 z-50 h-full w-[280px] bg-white dark:bg-gray-800 border-l border-gray-200 dark:border-gray-700 transform transition-transform duration-300 ease-in-out flex flex-col"
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
        ...
        <p class="text-xs text-gray-500 dark:text-gray-400">لوحة التحكم الموحدة</p>
    </div>
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3" style="scrollbar-width: thin;">
        ...
        <!-- ═══ نظرة عامة ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">نظرة عامة</h3>
            @if(Route::has('dashboard.index'))
                <a href="{{ route('dashboard.index') }}" 
        ...
        <!-- ═══ العمليات التجارية ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">العمليات التجارية</h3>
        ...
        <!-- ═══ الخدمات اللوجستية ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">الخدمات اللوجستية</h3>
        ...
        <!-- ═══ إدارة المحتوى ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">إدارة المحتوى</h3>
        ...
        <!-- ═══ التحليلات والتقارير ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">التحليلات والتقارير</h3>
        ...
        <!-- ═══ إدارة النظام ═══ -->
        <div class="mb-6">
            <h3 class="px-3 mb-2 text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider">إدارة النظام</h3>
