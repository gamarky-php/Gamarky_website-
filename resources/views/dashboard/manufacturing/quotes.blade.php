...
<div class="bg-gradient-to-r from-indigo-600 to-indigo-700 border-b border-indigo-800 mb-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">{{ __('عروض التصنيع') }}</h1>
                <p class="text-indigo-100">{{ __('إدارة ومتابعة عروض أسعار التصنيع المرتبطة بطلباتك') }}</p>
            </div>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-gray-900">{{ __('قائمة العروض') }}</h2>
                <span class="px-3 py-1 text-xs font-medium text-indigo-600 bg-indigo-50 rounded-full">{{ __('قيد التطوير') }}</span>
            </div>
        </div>
        ...
        <div class="p-6">
            ...
            <div class="text-center py-16">
                ...
                <h3 class="text-xl font-bold text-gray-900 mb-2">{{ __('لا توجد عروض حتى الآن') }}</h3>
                <p class="text-gray-500 mb-6 max-w-md mx-auto">{{ __('ابدأ بإنشاء طلب عرض سعر جديد لتصنيع منتجاتك وستظهر جميع العروض هنا') }}</p>
