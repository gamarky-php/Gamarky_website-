...
@section('title', 'مراجعة الموردين المستوردين')

@section('content')
<div class="container mx-auto px-4 py-6" dir="rtl">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-3xl font-bold text-gray-800">مراجعة الموردين المستوردين</h1>
                ...
                <div class="p-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        <h2 class="text-lg font-semibold text-gray-800">
                            الموردين في انتظار المراجعة ({{ $pendingSuppliers->total() }})
                        </h2>
                        <div class="flex items-center gap-2">
                    ...
                    <table class="min-w-full text-sm">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-right font-medium text-gray-900">اسم الشركة</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">المقاطعة</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">المدينة</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">جهة الاتصال</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">الهاتف المحمول</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">الموقع الإلكتروني</th>
                                <th class="px-4 py-3 text-right font-medium text-gray-900">تاريخ الإضافة</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($pendingSuppliers as $supplier)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-4 py-3 text-gray-700">{{ $supplier->province ?: 'غير محدد' }}</td>
                                    <td class="px-4 py-3 text-gray-700">{{ $supplier->city ?: 'غير محدد' }}</td>
                                    ...
                                    <td class="px-4 py-3 text-gray-700">{{ $supplier->mobile_phone ?: 'غير محدد' }}</td>
                                    <td class="px-4 py-3">
                                        @if($supplier->website)
                ...
                <div class="p-4 border-t border-gray-200 bg-gray-50">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-600">
                            <span id="selectedCount">0</span> مورد محدد
                        </div>
    ...
    @else
        <div class="bg-white rounded-lg shadow-md p-12 text-center">
            ...
            <h3 class="mt-2 text-lg font-medium text-gray-900">لا توجد موردين في انتظار المراجعة</h3>
            <p class="mt-1 text-sm text-gray-500">جميع الموردين تم اعتمادهم أو لم يتم استيراد موردين جدد بعد.</p>
            <div class="mt-6">
