<?php $__env->startSection('title','الرئيسية | جماركي'); ?>
  ...
  <div class="container mx-auto px-4 py-12">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 mb-8 text-center">
      ...
      <div class="flex gap-4 justify-center">
        ...
        <a href="<?php echo e(url('/register')); ?>" class="bg-white text-[#143B6E] border-2 border-[#143B6E] px-6 py-3 rounded-lg hover:bg-slate-50 transition">ابدأ الآن</a>
      </div>
    </div>
    ...
    <div id="services" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.import.calculator')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.export.calculator')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.manufacturing.calculator')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.customs.index')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.agent.shipping')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition">
        ...
        <a href="<?php echo e(route('front.shipping.quote')); ?>" class="text-[#2563EB] hover:underline">اعرف المزيد →</a>
      </div>
    </div>
  </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.front', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\gamarky\resources\views/front/home.blade.php ENDPATH**/ ?>